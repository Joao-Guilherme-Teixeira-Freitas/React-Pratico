...
export const DASHBOARD = ({ children }: { children: JSX.Element }) => {
  const auth = useAuth();
...
<Content className="content-pizza-tabela"> {/*grafico pizza e tabela*/}


<Row>
    <Col xs={24}>
    <div className="tabela"> {/*tabela*/}
...
</Content> {/*fim grafico pizza e tabela*/}
